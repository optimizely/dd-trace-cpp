...
SECTION("W3C Phase 3 support - Preferring tracecontext") {
    // Tests behavior from system-test test_headers_tracecontext.py::test_tracestate_w3c_p_extract_datadog_w3c
    struct TestCase {
      int line;
      std::string name;
      std::string traceparent;
    ...
    auto test_case = GENERATE(values<TestCase>({
        {
            ...
            "00-11111111111111110000000000000001-000000003ade68b1-01",  // traceparent
...

        {
            ...
            "00-11111111111111110000000000000002-000000003ade68b1-01",  // traceparent
...

        {
            ...
            "00-11111111111111110000000000000003-000000003ade68b1-01",  // traceparent
            "dd=s:2;p:000000000000000a,foo=1",                          // tracestate
...

        {
            ...
            "00-00000000000000000000000000000004-000000003ade68b1-01",  // traceparent
...

        {
            ...
            "00-00000000000000000000000000000005-000000003ade68b1-01",  // traceparent
